 ...
 * - NORMAL_BEHAVIOUR
 */
class EnumSource extends DataGeneratorAbstract {
  constructor(data) {
    super(data);
  ...
  readData() {
    ...
    switch (beha) {
      ...
      case NORMAL_BEHAVIOUR:
        value = getRandomEnum(this.values);
        break;
      default:
        console.error(`[EnumSource] Unsupported behaviour: ${beha}`);
        value = this.value;
        break;
    }
    this.value = value;
